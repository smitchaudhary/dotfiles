...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // Sample iChannel0 to get background correctly
    ...
    const float MIN_ANIMATION_LENGTH_THRESHOLD = currentCursor.w * 1.2;
    ...
    // NOTE: Only works correctly if the TRAIL_COLOR is same as iCurrentCursorColor
    lineLength = lineLength * step(MIN_ANIMATION_LENGTH_THRESHOLD, lineLength);
